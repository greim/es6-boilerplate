...
/*
 * Exposes server-side handlebars capabilities.
 * Note: this is pretty basic; no hot-reloading or
 * path-based partial support. That's because
 * handlebars is only a lightly-used utility in
 * this app, and React used to build DOM.
 */
